...
import com.example.navigationdrawer.test.PlaceAutocompleteAdapter;
...
//        mSearchText.setAdapter(placeAutocompleteAdapter);
        ...
        mSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, searchFragment)
                        .commit();
            }
        });
        hideSoftKeyboard();
